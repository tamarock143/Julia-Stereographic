...
plot((0:1:5000)*stepssrw,autocor(srwout.x[:,1], 0:1:5000), label="Autocorrelation of x_1")
plot!(x -> 0, lwd = 3, label="")

plot((0:1:20000)*stepssrw,autocor(srwout.z[:,end], 0:1:20000), label="Autocorrelation of z_{d+1}")
plot!(x -> 0, lwd = 3, label="")
